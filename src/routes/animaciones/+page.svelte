...
<div class="column"><img src="https://storage.googleapis.com/patraldo/antoine-dibujos/animaciones/GIFs/AntoineArtistAutoctonx.gif" alt="animation of drawing against background by Antoinex " onclick="window.open(this.src, '_blank')"></div>
<div class="column"><img src="https://storage.googleapis.com/patraldo/antoine-dibujos/animaciones/GIFs/BG-2HM-Landscape.gif" alt="animation of drawing against background by Antoinex " onclick="window.open(this.src, '_blank')"></div>
